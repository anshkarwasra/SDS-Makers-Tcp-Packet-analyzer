...
const WorldMapArcs = ({ cityCords, connections }) => {
    ...
    <div className="relative w-full h-screen">
      ...
      >
        ...
        {connections.map((connection, index) => {
          ...
          if (!fromCity || !toCity) {
            console.warn('Missing city:', !fromCity ? connection.from : connection.to);
            return null;
          }
        ...
        {uniqueCities.map((cityName, index) => {
          ...
          const labelCoords = getLabelPosition(coords, index, uniqueCities.length);
